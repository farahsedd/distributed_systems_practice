...
public class Bo2 extends  JFrame{
    ...
    private String url = "jdbc:mysql://localhost:3307/ho2";
    private String user = "root@";
    private String password = "";

    public Bo2() throws IOException, TimeoutException {
        super("Branch Office 2 Database Table Content");
        ...
        String routingKey = "my-routing-key-2";
                ...
                if (result == JOptionPane.OK_OPTION) {
                    ...
                    try {
                        ...
                        try {
                            ...
                            String message= "INSERT INTO productsales (id, date, region, product, qty, cost, amnt, tax, total, copied, idbranch, bo) VALUES (?, '"+date+"', '"+region+"' ,'"+productName+"' ,"+qty+" ,"+cost+" ,"+amnt+" ,"+tax+" ,"+total+",1 ,"+newId+" ,2)";
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (result == JOptionPane.OK_OPTION) {
                    ...
                    try {
                        ...
                        try {
                            channel.confirmSelect(); // enable publisher confirms
                            String message= "UPDATE productsales SET date='"+date+"', region='"+region+"', product='"+newProductName+"', qty='"+qty+"', cost='"+cost+"', amnt='"+amnt+"', tax='"+tax+"', total='"+total+"' WHERE idbranch='"+id+"' AND bo='2'";
                            channel.addConfirmListener(new ConfirmListener() {
                                public void handleAck(long deliveryTag, boolean multiple) throws IOException {
                                    // The message was successfully acknowledged
                                    System.out.println("Message " + deliveryTag + " was successfully acknowledged.");
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (confirm == JOptionPane.YES_OPTION) {
                    ...
                    try {
                        ...
                        try {
                            channel.confirmSelect();// enable publisher confirms
                            String message="DELETE FROM productsales WHERE idbranch='"+productId+"' AND bo='2'";
                            channel.addConfirmListener(new ConfirmListener() {
                                public void handleAck(long deliveryTag, boolean multiple) throws IOException {
                                    // The message was successfully acknowledged
                                    System.out.println("Message " + deliveryTag + " was successfully acknowledged.");
